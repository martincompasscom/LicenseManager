...
Private clsLicKeyCreator As clsLicCreator
Private clsLicKeyExtractor As clsLicExtractor


Private Sub Form_Load()

   Set clsLicKeyCreator = New clsLicCreator
   Set clsLicKeyExtractor = New clsLicExtractor
